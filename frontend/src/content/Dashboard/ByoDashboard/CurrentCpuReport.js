...
const CurrentCpuReport = (props) => {
  ...
  const getMaxBx2Value = vsiuProfile => {
    const bxVal = props.byoReportLists.find(f => f.vsiuProfile === vsiuProfile);
    return bxVal ? bxVal.maxCpuUtilization : null;
  };
  ...
  let primaryTitle = t('byo.currentCpuPrimaryTitle');
  let axesTitle= t('byo.currentCpuAxesTitle');
...
export default CurrentCpuReport;
